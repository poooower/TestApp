package com.github.poooower.mvrxext
...
abstract class BaseListFragment : BaseMvRxFragment() {
    ...
    override fun onCreateView(
        ...
        return inflater.inflate(R.layout.fragment_list_mvrxext, container, false).apply {
